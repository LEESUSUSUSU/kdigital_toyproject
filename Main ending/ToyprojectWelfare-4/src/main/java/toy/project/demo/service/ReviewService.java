...
public class ReviewService {
	...
	public Review insertReview(Review review) throws IOException {
...
// 적절한 예외 처리
	...
	public Review updateReview(Integer seq, String notename,  String notePass, String note, String sw_name, String username) throws IOException {
	    Review review = reviewRepository.findById(seq).orElse(null);
	    
	    String sw_name_temp = review.getSw_name();
	    String username_temp = review.getUsername();
